...
# Feasibility analysis: combine 2a on one subplot, 2d on another, and plot both in one graph.
python experimentAnalysis/fa.py experimentAnalysis/log3_archives/2ad 2ad ~/repos/hcomp2014/figures
...
# Crowd analysis: action log analysis (did users learn [get faster] over time?)
python experimentCrowd/ala.py ~/repos/hcomp2014/figures
