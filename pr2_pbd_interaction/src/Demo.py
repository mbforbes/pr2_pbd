...
class Demo:
    ...
    def __init__(self, arms):
        ...
        # "Above" z position. Originally 0.8. I'm adding some amount to
        # the block position. It appears + 5cm (0.05) is about as low as
        # you can go without running into other blocks.
        ...
        # turtle from video 1 (lowest task difficulty)
        ...
        # self.colors[(5,6)] = Block.RED
        # self.colors[(6,3)] = Block.GREEN
        # self.colors[(6,5)] = Block.GREEN

        # turtle from video 2 (highest task difficulty)
        # NOTE(max): I'm leaving off the last column so as to avoid
        # going to a 9 x 9 grid. The last column contains the following
        # blocks:
        # 4,8 GREEN
        # 6,8 GREEN
